...
%
  \item there are many ways to force the framework to recognize these settings
    \begin{itemize}
    \item the natural one is to place them in a file call \package{stitch.pfg} in the working
      directory
...
\begin{frame}
%
  \frametitle{The interactive shell}
%
\end{frame}
...
%
  \frametitle{The plexus structure}
%
  \vskip -3ex
  \only<1>{
    \begin{center}
