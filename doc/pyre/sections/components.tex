...
%
  \item \emph{instances} are containers of state; there are special rules
    ...
    \end{itemize}
%
  \item these ideas have been around for a while\cite{simula,eiffel}, and have been
    explored extensively and formalized\cite{meyer-97}
%
  \item \pyre\ \emph{components} are classes that specifically grant access to some of their
    ...
    \end{itemize}
%
  \item the notion is quite old\cite{mcilroy-69} and the terms heavily overloaded; \pyre\
...
%
  \begin{itemize}
%
  \item together, they form a design pattern that enables the assembly of applications out of
    interchangeable parts, under the control of the {\em end user}
      \begin{itemize}
      ...
      \end{itemize}
%
    \item protocols make it possible to write applications without any {\em a priori} knowledge
      of implementation specifics
%
    \item inversion of control\cite{johnson-88}:
      \begin{itemize}
